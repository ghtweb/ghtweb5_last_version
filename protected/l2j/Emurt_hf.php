...
class Emurt_hf extends AbstractQuery
{
    /**
     * Поля из БД
     * @var array
    ...
    public function characters($command = null)
    {
        ...
        /*
            ...
            character_subclasses.curHp,character_subclasses.curMp,character_subclasses.curCp,clan_data.clan_level,clan_data.hasCastle,clan_data.hasFortress AS hasFort,clan_data.crest AS clan_crest,clan_data.reputation_score,clan_subpledges.name AS clan_name,
    ...
    public function clans($command = null)
    {
        ...
        /*
            SELECT
            clan_data.clan_id,clan_subpledges.name AS clan_name,clan_data.clan_level,clan_data.hasCastle,clan_data.hasFortress AS hasFort,clan_data.ally_id,ally_data.ally_name,clan_subpledges.leader_id,clan_data.crest AS clan_crest,clan_data.largecrest AS clan_crest_large,
            ally_data.crest AS ally_crest,clan_data.reputation_score,characters.char_name,characters.account_name,characters.obj_Id AS char_id,character_subclasses.level,character_subclasses.curHp,character_subclasses.curMp,character_subclasses.curCp,
            character_subclasses.maxHp,character_subclasses.maxMp,character_subclasses.maxCp,characters.sex,characters.x,characters.y,characters.z,character_subclasses.exp,character_subclasses.sp,characters.karma,characters.pvpkills,characters.pkkills,
            character_subclasses.class_id AS base_class,characters.title,characters.online,characters.onlinetime,characters.accesslevel AS access_level,(SELECT COUNT(0) FROM characters WHERE clanid = clan_data.clan_id) as ccount
            FROM
            clan_data
        ...
        */
        ...
        return $command
            ->select('clan_data.clan_id,clan_subpledges.name AS clan_name,clan_data.clan_level,clan_data.hasCastle,clan_data.hasFortress AS hasFort,clan_data.ally_id,ally_data.ally_name,clan_subpledges.leader_id,clan_data.crest AS clan_crest,clan_data.largecrest AS clan_crest_large,
                ally_data.crest AS ally_crest,clan_data.reputation_score,characters.char_name,characters.account_name,characters.obj_Id AS char_id,character_subclasses.level,character_subclasses.curHp,character_subclasses.curMp,character_subclasses.curCp,
                character_subclasses.maxHp,character_subclasses.maxMp,character_subclasses.maxCp,characters.sex,characters.x,characters.y,characters.z,character_subclasses.exp,character_subclasses.sp,characters.karma,characters.pvpkills,characters.pkkills,
                character_subclasses.class_id AS base_class,characters.title,characters.online,characters.onlinetime,characters.accesslevel AS access_level,(SELECT COUNT(0) FROM characters WHERE characters.clanid = clan_data.clan_id) as ccount')
            ->leftJoin('clan_subpledges', 'clan_data.clan_id = clan_subpledges.clan_id AND clan_subpledges.type = 0')
    ...
    public function getItemsControl(array $itemsIds)
    {
        ...
        $res = $this->_db->createCommand()
            ->select("Max(items.count) AS maxCountItems,Count(items.count) AS countItems,items.object_id,items.owner_id,items.item_id,items.count,items.enchant_level,items.loc,items.loc_data,characters.account_name,characters.char_name,characters.x,characters.y,characters.z,characters.obj_Id AS char_id,characters.sex,characters.karma,
                ...
                clan_data.crest AS clan_crest,clan_data.reputation_score,clan_subpledges.name AS clan_name")
