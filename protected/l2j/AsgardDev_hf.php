...
/**
 * Сайт команды разработчиков: http://asgard-dev.ru/index.php
 * Версия сервера на которой писались запросы: R15-01
 * Автор: ght^^ (http://ghtweb.ru/)
 * Дата создания файла с запросами: 2015-03-01 13:04:00
 */
class AsgardDev_hf extends AbstractQuery
{
    /**
     * Поля из БД
     * @var array
