...
/**
 * Сайт команды разработчиков: http://l2-scripts.ru/
 * Версия сервера на которой писались запросы: 11489
 * Автор: ght^^ (http://ghtweb.ru/)
 * Дата создания файла с запросами: 2014-11-20 23:22:20
 */
class L2Scripts_hf extends AbstractQuery
{
    /**
     * Поля из БД
     * @var array
