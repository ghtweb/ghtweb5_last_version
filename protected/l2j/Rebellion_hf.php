...
/**
 * Сайт команды разработчиков: http://rebellion-team.ru/
 * Версия сервера на которой писались запросы:
 * Автор: ght^^ (http://ghtweb.ru/)
 * Дата создания файла с запросами: 2014-12-05 00:06:45
 */
class Rebellion_hf extends AbstractQuery
{
    /**
     * Поля из БД
     * @var array
