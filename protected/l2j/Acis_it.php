...
/**
 * Сайт команды разработчиков: http://acis.i-live.eu/
 * Версия сервера на которой писались запросы: 342
 * Автор: ght^^ (http://ghtweb.ru/)
 * Дата создания файла с запросами: 2015-03-03 13:03:44
 */
class Acis_it extends AbstractQuery
{
    /**
     * Поля из БД
     * @var array
