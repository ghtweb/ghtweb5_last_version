...
/**
 * Сайт команды разработчиков: http://l2j-dev.ru/
 * Версия сервера на которой писались запросы: 1540
 * Автор: ght^^ (http://ghtweb.ru/)
 * Дата создания файла с запросами: 2014-12-08 23:09:45
 */
class l2j_dev_hf extends AbstractQuery
{
    /**
     * Поля из БД
     * @var array
