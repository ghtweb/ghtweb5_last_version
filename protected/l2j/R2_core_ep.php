...
class R2_core_ep extends AbstractQuery
{
    /**
     * Поля из БД
     * @var array
    ...
    public function getCastles()
    {
        /*
            SELECT
            castle.id,castle.name,castle.taxPercent AS taxPercent,castle.siegeDate AS siegeDate,clan_data.clan_id,clan_data.clan_level,clan_data.reputation_score,clan_data.hasCastle,clan_data.hasFortress AS hasFort,clan_data.clan_name,clan_data.ally_id,
         ...
         */
        return $this->_db->createCommand()
            ->select('castle.id,castle.name,castle.taxPercent AS taxPercent,castle.siegeDate AS siegeDate,clan_data.clan_id,clan_data.clan_level,clan_data.reputation_score,clan_data.hasCastle,clan_data.hasFortress AS hasFort,clan_data.clan_name,clan_data.ally_id,
                ally_data.ally_name,clan_subpledges.leader_id,clan_data.crest AS clan_crest,clan_data.largecrest AS clan_crest_large,ally_data.crest AS ally_crest')
